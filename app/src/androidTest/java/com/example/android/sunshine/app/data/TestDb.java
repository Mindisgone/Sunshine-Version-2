...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        //move the cursor to demonstrate there is one one record in the database
    ...
    public void testWeatherTable() {
        ...
        ContentValues values = TestUtilities.createWeatherValues(TestUtilities.insertNorthPoleLocationValues(mContext));
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather query failed", cursor, values);
